...
func rejectReplaySymlinkBeforeOpen(string) error {
	// openReplayFileNoFollow opens the path itself and rejects reparse points
	// through the resulting share-delete handle.
	return nil
}
